                ...
                <View style={styles.heroCard}>
                    ...
                    <View style={styles.heroStatsGrid}>
                        <View style={styles.heroStatItem}>
                            <Text style={[styles.heroStatValue, { color: '#FFFFFF' }]}>12</Text>
                            <Text style={styles.heroStatLabel}>Lotes Activos</Text>
                        </View>
                        <View style={styles.heroStatDivider} />
                        <View style={styles.heroStatItem}>
                            <Text style={[styles.heroStatValue, { color: '#FFFFFF' }]}>98%</Text>
                            <Text style={styles.heroStatLabel}>Sincronizados</Text>
                        </View>
                        <View style={styles.heroStatDivider} />
                        <View style={styles.heroStatItem}>
                            <Text style={[styles.heroStatValue, { color: '#34C759' }]}>OK</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.quickAccessGrid}>
                        ...
                        >
                            ...
                            <Text style={[styles.quickCardTitle, { color: textPrimary }]}>Gestión de Lotes</Text>
                        ...
                        >
                            <View style={[styles.metricIconWrap, { backgroundColor: 'rgba(255, 149, 0, 0.1)' }]}>
                                <MaterialCommunityIcons name="book-open-variant" size={18} color="#FF9500" />
                            </View>
                            <Text style={[styles.quickCardTitle, { color: textPrimary }]}>Biblioteca</Text>
                            <Text style={[styles.quickCardSubtitle, { color: textSecondary }]}>Guías y manuales</Text>
                        </TouchableOpacity>
                    </View>
                </View>
